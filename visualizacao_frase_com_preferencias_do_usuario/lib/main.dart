...
class _HomeState extends State<Home> {
  ...
  Future<void> _funcaoInicializaShared() async {
    ...
    setState(() {
      ...
      valorSwitchDia == true ? corFundo = Colors.white : corFundo = Colors.grey.shade700;
        ...
        child: Column(
          children: [
            ...
            Container(
              width: size,
              height: 400,
              child: Text('A vingança nunca é plena, mata a alma e envenena (Seu Madruga)', style: TextStyle(fontSize: tamanhoFonte)),
